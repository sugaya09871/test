...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__module_redirect__ = __webpack_require__(2);
...
class Redirect {
  ...
  //ウィンドウの横幅を取得
  getWindowWidth() {
    this.width = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).width();
    return this.width;
  }
...
class setHeight {
  ...
  //ウィンドウの高さを取得
  getWindowHeight() {
    this.height = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).height();
    return this.height;
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = setHeight;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_animejs__ = __webpack_require__(6);
...
class onePageScroll {
  ...
  //コンテンツの始まりの値を取得
  getStartContent() {
    this.contentTop = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.target).offset().top;
    return this.contentTop;
  }

  //コンテンツの高さの値を取得
  getContentHeight() {
    this.contentTop = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.target).height();
    return this.contentTop;
  }

  responsive() {

    console.log('高さ' + this.getContentHeight());
    console.log('上' + this.getStartContent());
    console.log('スクロール' + this.getScrollTop());

    if (this.getStartContent() < this.getScrollTop() && !this.animationFlag && !this.endAnimation) {
      this.animationFlag = true;
      // this.ofset = this.getScrollTop();
